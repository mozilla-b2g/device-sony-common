...
ZIP_FILE="SW_binaries_for_Xperia_AOSP_L_MR1_v19a.zip"
URL_BASE="http://dl-developer.sonymobile.com/eula"
EULA_URL="${URL_BASE}/SW_binaries_for_Xperia_AOSP_L_MR1_v19a_EULA.html"
...
mkdir -p ${DIR} && (cd ${DIR} && sha1sum --status -c ../device/sony/common/blobs-sha1.txt) ||
(
